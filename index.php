...
<html>
	<head>
		...
		<link rel="stylesheet" href="css/main_page.css" type="text/css" media="screen"/>
		<style>
			.overlay {
		...
		<script type="text/javascript">
			$(window).load(function() {
				...
				var fadeSpeed = 200;
				$('#thumbScroller .thumb').hover(function() {//mouse over
	...
	<body>
			...
			<div id="outer_container">
				<div id="thumbScroller">
					<div class="container">
						<div class="content">
							<div>
								<a href="#"><img src="images/thumbs/1.jpg" alt="images/1.jpg" class="thumb" /></a>
							</div>
						</div>
						<div class="content">
							<div>
								<a href="#"><img src="images/thumbs/2.jpg" alt="images/2.jpg" class="thumb" /></a>
							</div>
						</div>
						<div class="content">
							<div>
								<a href="#"><img src="images/thumbs/3.jpg" alt="images/3.jpg" class="thumb" /></a>
							</div>
						</div>
						<div class="content">
							<div>
								<a href="#"><img src="images/thumbs/4.jpg" alt="images/4.jpg" class="thumb" /></a>
							</div>
						</div>
						<div class="content">
							<div>
								<a href="#"><img src="images/thumbs/5.jpg" alt="images/5.jpg" class="thumb" /></a>
							</div>
						</div>
					</div>
				</div>
		...
		<div>
			<span class="reference"> 
				<a href="php/login.php" rel="#overlay" >Login</a> 
				<a href="php/register.php" rel="#overlay">Signup</a> 
				</span>
		</div>
		 overlayed element 
